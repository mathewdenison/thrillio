package com.mathewdenison.thrillio.constants;

/**
 * Constant class for holding values of MovieGenres.
 */
public class MovieGenre {
  ...
  public static final String FOREIGN_ACTION_MOVIES = "Foreign Action Movies";
