...
class BookTest {
  ...
  void isKidFriendlyEligible() {
    ...
    //Test 1
    Book book = BookmarkManager.getInstance()
    ...
    assertFalse(isKidFriendlyEligible,
        "For Philosophy Genre - isKidFriendlyEligible should return false");
    ...
    assertFalse(isKidFriendlyEligible,
        "For Self Help genre - isKidFriendlyEligible should return false");
  }
}